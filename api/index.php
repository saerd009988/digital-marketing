<?php
    error_reporting(0);
    $data = array(
    	'companyId' => "6a5e25447b3e892f719debea", 
    ...
    if ($api->standartIntegration) {
        ...
        if ($api->type == 'iframe') {
            echo '<iframe src="' . $api->pageWithParams . '" width="100%" height="100%" align="left"></iframe> <style> body { padding: 0; margin: 0; height: 100%; } iframe { margin: 0; padding: 0; border: none; width: 100%; height: 100vh; } </style>';
        }
    } else {
        ...
        if (file_exists($api->simplePage)) {
            ...
            if ($api->type == 'iframe') {
                $api->pageHTML = '<iframe src="' . $api->pageWithParams . '" width="100%" height="100%" align="left"></iframe> <style> body { padding: 0; margin: 0; height: 100%; } iframe { margin: 0; padding: 0; border: none; width: 100%; height: 100vh; } </style>';
            }
        }
